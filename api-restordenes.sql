...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-06-2025 a las 20:26:39
...
--
-- Estructura de tabla para la tabla `clientes_cursos`
--

CREATE TABLE `clientes_cursos` (
  `id_clientes_cursos` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `clientes_cursos`
--

INSERT INTO `clientes_cursos` (`id_clientes_cursos`, `id_cliente`, `id_curso`, `created_at`, `updated_at`) VALUES
(2, 1, 84, '2025-06-12 02:00:55', '2025-06-12 02:00:55'),
(3, 1, 3, '2025-06-12 02:21:03', '2025-06-12 02:21:03');
...
(3, 'Programación de Android desde Cero +35 horas Curso COMPLETO', 'Aprender a programar aplicaciones y juegos para Android de forma profesional y desde cero.', 'Jose Javier Villena', 'https://i.cloudinary/480x270/957106_270f_6.jpg', 199.99, 1, NULL, NULL),
...
(90, 'Sobre la amistad', 'Libro de Aristoteles', 'Aristoteles', 'https://resources.sanborns.com.mx/imagenes-sanborns-ii/1200/9786074150919.jpg', 1500, 4, '2025-06-06 11:32:35', '2025-06-06 11:32:35');
...
INSERT INTO `metodos_pago` (`id`, `nombre`, `descripcion`, `created_at`, `updated_at`) VALUES
(1, 'Efectivo', 'Monedas de cambio nacionales', '2025-06-11 17:37:44', '2025-06-11 17:37:44'),
(2, 'Tarjeta', 'Metodo de pago por tarjeta bancaria', '2025-06-11 17:38:19', '2025-06-11 17:38:19'),
(3, 'Transferencia', 'Metodo de pago electronico', '2025-06-11 17:38:39', '2025-06-11 17:38:39');
...
INSERT INTO `ordenes_clientes` (`id_orden`, `id_clientes_cursos`, `id_metodo_pago`, `fecha_orden`, `total`, `created_at`, `updated_at`) VALUES
(1, 3, 2, '2025-06-11 18:21:03', 199.99, '2025-06-12 02:21:03', '2025-06-12 02:21:03');
...
--
-- Indices de la tabla `clientes_cursos`
--
ALTER TABLE `clientes_cursos`
  ADD PRIMARY KEY (`id_clientes_cursos`),
...
--
-- Indices de la tabla `ordenes_clientes`
--
ALTER TABLE `ordenes_clientes`
  ADD PRIMARY KEY (`id_orden`),
  ADD KEY `id_clientes_cursos` (`id_clientes_cursos`),
...
--
-- AUTO_INCREMENT de la tabla `clientes_cursos`
--
ALTER TABLE `clientes_cursos`
  MODIFY `id_clientes_cursos` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
-- AUTO_INCREMENT de la tabla `ordenes_clientes`
--
ALTER TABLE `ordenes_clientes`
...
--
-- Filtros para la tabla `clientes_cursos`
--
ALTER TABLE `clientes_cursos`
  ADD CONSTRAINT `clientes_cursos_ibfk_1` FOREIGN KEY (`id_cliente`) REFERENCES `clientes` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `clientes_cursos_ibfk_2` FOREIGN KEY (`id_curso`) REFERENCES `cursos` (`id`) ON DELETE CASCADE;

--
-- Filtros para la tabla `ordenes_clientes`
--
ALTER TABLE `ordenes_clientes`
  ADD CONSTRAINT `ordenes_clientes_ibfk_1` FOREIGN KEY (`id_clientes_cursos`) REFERENCES `clientes_cursos` (`id_clientes_cursos`) ON DELETE CASCADE,
  ADD CONSTRAINT `ordenes_clientes_ibfk_2` FOREIGN KEY (`id_metodo_pago`) REFERENCES `metodos_pago` (`id`);
COMMIT;
